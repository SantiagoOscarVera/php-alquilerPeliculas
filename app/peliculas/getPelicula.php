...
if ($row > 0) { /* si es mayor a cero significa que si trae informacion */
    $pelicula = $resultado->fetch_arrays(); /* a la variable pelicula le asignamos el resultado pero con la funcion "fetch_arrays()" para que nos traiga los datos id, nombre, descripcion, genero como arreglos*/
}
